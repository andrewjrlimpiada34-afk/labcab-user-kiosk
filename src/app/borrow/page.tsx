...
import { 
  ChevronLeft, QrCode, Mail, Lock, CheckCircle2, ShoppingBag, Plus, Minus, 
...
export default function BorrowPage() {
  ...
  const finalizeBorrowing = async () => {
    ...
    else deadline.setHours(17, 0, 0); // End of Day
      ...
      <AnimatePresence mode="wait">
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <Input placeholder="university.edu.ph" className="h-16 pl-12 text-xl rounded-2xl" value={email} onFocus={() => setActiveField('email')} readOnly />
                  </div>
                </div>
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <Input type="password" placeholder="••••••••" className="h-16 pl-12 text-xl rounded-2xl" value={password} onFocus={() => setActiveField('password')} readOnly />
                  </div>
                </div>
        ...
        {step === 'success' && (
          <motion.div key="success" initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="flex flex-col items-center justify-center text-center space-y-12">
            ...
            <div className="space-y-4">
              <h2 className="text-6xl md:text-7xl font-black text-slate-900">Borrowing Confirmed</h2>
              <p className="text-2xl md:text-3xl text-slate-500 font-medium">Cabinet doors are unlocked. Please take your items.</p>
            </div>
