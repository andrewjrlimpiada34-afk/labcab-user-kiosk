...
import { ChevronLeft, GraduationCap, UserCog, Mail, Lock, User, QrCode, CheckCircle2, Building2 } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="kiosk-page p-12 overflow-y-auto">
      <header className="flex items-center justify-between mb-12">
        <Button 
          variant="ghost" 
          className="rounded-full w-20 h-20 ripple" 
          onClick={() => step === 'form' ? setStep('type') : router.push('/')}
        >
        ...
        {step === 'type' && (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-10 w-full max-w-4xl">
              <Button
                variant="outline"
                className="h-96 rounded-[3rem] flex flex-col gap-6 text-slate-700 border-4 hover:border-primary hover:bg-primary/5 shadow-xl transition-all active:scale-95"
              ...
              <Button
                variant="outline"
                className="h-96 rounded-[3rem] flex flex-col gap-6 text-slate-700 border-4 hover:border-secondary hover:bg-secondary/5 shadow-xl transition-all active:scale-95"
        ...
        {step === 'form' && (
          ...
          >
            <div className="grid grid-cols-6 gap-6">
              <div className="col-span-2 space-y-3">
                ...
                <Input 
                  ...
                  className="h-16 text-2xl rounded-2xl"
              ...
              <div className="col-span-1 space-y-3">
                ...
                <Input 
                  placeholder="Opt" 
                  className="h-16 text-2xl rounded-2xl text-center"
                  value={formData.mi}
                  onFocus={() => setActiveField('mi')}
                  readOnly
                />
              </div>
            ...
            <div className="pt-6">
              <Button
                type="button"
                className={`w-full h-24 rounded-3xl text-3xl font-black gap-4 shadow-xl ripple ${formData.qrCode ? 'bg-green-600' : 'bg-slate-800'}`}
            ...
            <Button
              type="submit"
              className="w-full h-24 rounded-3xl text-3xl font-black bg-primary ripple shadow-2xl"
            >
