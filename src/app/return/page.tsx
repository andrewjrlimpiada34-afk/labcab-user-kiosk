              ...
              <div className="max-w-3xl mx-auto">
                <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-100 flex flex-col items-center gap-8 text-center">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-3xl md:text-4xl font-black text-slate-800">QR First Return</h3>
                    <p className="text-slate-500 text-lg md:text-xl">Point your ID QR code at the camera to continue returning apparatus.</p>
                  </div>
